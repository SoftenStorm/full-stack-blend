...
// Auto[ClassBegin]--->
class Image_b5b7d5ec extends Base {
  state: IState = null;
  ...
  protected render(): any {
    TestHelper.identify();
    return pug `
      div(style=Object.assign({padding: '0px'}, this.props.forward && this.props.forward.styles || {}), className="col-12 d-lg-block d-md-none d-none d-sm-none d-xl-block internal-fsb-element " + (this.props.forward && this.props.forward.classes || ''), internal-fsb-guid="b5b7d5ec")
        img(style={'position': 'relative', 'top': '-80px', 'width': '100%'}, ref="image", internal-fsb-event-no-propagate="1", internal-fsb-name="Figure For Large Screen", internal-fsb-react-code-body="
...
DeclarationHelper.declare('Document', 'Controls.Image_b5b7d5ec', Image_b5b7d5ec);
// <---Auto[ClassEnd]
