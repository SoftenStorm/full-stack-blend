...
// Auto[ClassBegin]--->
class Image_37722551 extends Base {
  state: IState = null;
  ...
  protected render(): any {
    TestHelper.identify();
    return pug `
      div(style=Object.assign({padding: '0px'}, this.props.forward && this.props.forward.styles || {}), className="col-12 col-md-10 d-block d-lg-none d-md-none d-sm-block d-xl-none internal-fsb-element offset-md-1 " + (this.props.forward && this.props.forward.classes || ''), internal-fsb-guid="37722551")
...
", src="https://static.wiseboq.com/homepage/role/bidder.png")
    `
  }
}
DeclarationHelper.declare('Document', 'Controls.Image_37722551', Image_37722551);
// <---Auto[ClassEnd]
