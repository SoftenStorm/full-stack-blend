...
// Auto[ClassBegin]--->
class Image_99ac95a4 extends Base {
  state: IState = null;
  ...
  protected render(): any {
    TestHelper.identify();
    return pug `
      div(style=Object.assign({padding: '0px'}, this.props.forward && this.props.forward.styles || {}), className="col-10 internal-fsb-element offset-1 " + (this.props.forward && this.props.forward.classes || ''), internal-fsb-guid="99ac95a4")
...
DeclarationHelper.declare('Document', 'Controls.Image_99ac95a4', Image_99ac95a4);
// <---Auto[ClassEnd]
