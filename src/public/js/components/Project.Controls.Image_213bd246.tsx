...
// Auto[ClassBegin]--->
class Image_213bd246 extends Base {
  state: IState = null;
  ...
  protected render(): any {
    TestHelper.identify();
    return pug `
      div(style=Object.assign({padding: '0px'}, this.props.forward && this.props.forward.styles || {}), className="col-12 internal-fsb-element " + (this.props.forward && this.props.forward.classes || ''), internal-fsb-guid="213bd246")
        img(style={'width': '100%'}, ref="image", internal-fsb-event-no-propagate="1", internal-fsb-name="Image 3", internal-fsb-react-code-body="
  ...
  ", src="https://static.wiseboq.com/homepage/material.png")
    `
  }
}
DeclarationHelper.declare('Document', 'Controls.Image_213bd246', Image_213bd246);
// <---Auto[ClassEnd]
